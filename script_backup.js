...
const projectsByCategory = {
    ...
    excel: [
        {
            id: "excel1",
            title: "Performance Commerciale & Segmentation RFM",
            category: "Excel Expert / Data Analysis",
            image: "excel_superstore_dashboard.png",
            description: "Analyse décisionnelle complète des données de vente de 'Global Superstore' (9 000+ transactions). Ce projet transforme des données brutes en un outil de pilotage stratégique permettant d'optimiser la rentabilité via une segmentation client avancée.",
            context_title: "Contexte et problématiques stratégiques",
            context: "L'objectif était de fournir à la direction une vision 360° sur 4 ans d'activité commerciale. Le projet répond à trois enjeux majeurs : le suivi de la rentabilité (CA vs Marge), l'identification des segments clients les plus porteurs et la détection des zones géographiques sous-performantes nécessitant des ajustements logistiques ou tarifaires.",
            method_title: "Méthodologie & Réalisations Techniques",
            method: `
                <p>Pour ce projet, j'ai exploité les fonctionnalités expertes d'Excel pour construire une solution robuste et automatisée :</p>
                
                <div class="tech-stack-mini" style="margin: 1.5rem 0; padding: 1rem; background: rgba(0,0,0,0.03); border-radius: 12px; display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
                    <strong>Pipeline technique :</strong>
                    <span style="display: flex; align-items: center; gap: 0.4rem; background: white; padding: 0.4rem 0.8rem; border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); font-size: 0.9rem;">Power Query (ETL)</span>
                    <span style="display: flex; align-items: center; gap: 0.4rem; background: white; padding: 0.4rem 0.8rem; border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); font-size: 0.9rem;">Power Pivot (Modélisation)</span>
                    <span style="display: flex; align-items: center; gap: 0.4rem; background: white; padding: 0.4rem 0.8rem; border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); font-size: 0.9rem;">DAX pour Excel</span>
                </div>

                <ul style="list-style-type: disc; margin-left: 1.5rem; margin-bottom: 1.5rem; display: flex; flex-direction: column; gap: 0.8rem; text-align: left;">
                    <li><strong>Nettoyage & Préparation (Power Query)</strong> : Connexion aux données brutes, normalisation des types, gestion des doublons et création d'une table de dates pour les analyses temporelles (YoY).</li>
                    <li><strong>Modélisation & Calculs (DAX)</strong> : Création de mesures calculées complexes pour le taux de marge, le panier moyen et l'évolution glissante du chiffre d'affaires.</li>
                    <li><strong>Segmentation RFM Avancée</strong> : Mise en place d'un système de scoring (Récence, Fréquence, Montant) pour classer les clients par catégories (Champions, Fidèles, À risque) et cibler les campagnes marketing.</li>
                    <li><strong>Interface Décisionnelle</strong> : Design d'un dashboard interactif utilisant des segments (Slicers) synchronisés pour filtrer par année, région et catégorie de produits en un clic.</li>
                </ul>
            `,
            skills_extra_title: "✅ Résultats & Insights",
            skills_extra: "L'analyse a révélé une saisonnalité critique au quatrième trimestre (Q4) et des pertes structurelles sur la catégorie 'Furniture' dans certaines régions. Ces insights permettent d'ajuster les coûts logistiques et de concentrer les efforts marketing sur les segments à haute valeur ajoutée identifiés par la segmentation RFM.",
            github: "https://github.com/moulhatah99/Portfolio_data/blob/main/Excel/SampleSuperstore/superstore.xlsx",
            conclusion: "Le fichier Excel complet incluant les requêtes Power Query et le modèle de données est disponible sur mon GitHub.",
            screenshots: [
                { src: "excel_superstore_dashboard.png", label: "Vue principale du Dashboard Sales Performance & Segmentation RFM" }
            ]
        }
    ],
    pbi: [
...
window.addEventListener('scroll', () => {
    if (window.scrollY > 50) {
        ...
        header.style.backgroundColor = 'rgba(2, 6, 23, 0.98)'; /* Bleu nuit profond */
    } else {
 bitumen color: var(--gray);
 bitumen color: var(--gray);
 bitumen color: var(--gray);
 bitumen color: var(--gray);
 bitumen color: var(--gray);
